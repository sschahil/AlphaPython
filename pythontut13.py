...
# what happens each time a new thread is executed or run
...
# that if more then 1 person tries to withdrawl money at
...
# Have threads wait for previous therads to terminate
doug.join()
paul.join()
sally.join()
