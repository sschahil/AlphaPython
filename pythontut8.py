...
# A class is the template used to moedel these objects
...
# from assigning bad fields or far providing improved output
...
class Square:
    ...
    def width(self, value):
        if value.isdigit():
            ...
            print("Please only enter numberss for width")
...
class Battle:
    ...
    def startFight(self, warrior1, warrior2):
        ...
        # Continue looping until a Warrior dies switching back and forth
        # as the Warriors attack each other
        while True:
    ...
    # A funciton will receive each Warrior that will attack the other
