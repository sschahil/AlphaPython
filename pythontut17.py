...
# .     : Match any 1 character of what proceeds
...
# Use a negative look behind to ony return numbers without
# a $ in front of them
...
# codes or zip codes with 5 digits a dash and then 4 digits

randStr = "12345 12345-1234 1234 123456-333"
...
# Print start and ending index of the match
print("Span :", match.span())

# Pring starting index of the match
