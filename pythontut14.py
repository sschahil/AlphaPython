# Regular expression allow you to locate and change
...
# You can get around this by using raw strins which
...
# want to match a period. Backslashes the period
...
if re.search("\w{2,20}\s\w{2,20}", "Toshito Muramatsu"):
