...
generated_func = get_func_mult_by_name(5)
...
# ---------------- PROBLEM ------------------
# Cretae a function that receives a list and a function
...
# lambda arg1, arg2, ... : excpression using the args

# lambdas are used when you need s small function, but
...
# Use a temporary operator to see if someone can vote
...
# keys() returns on iterable so we convert it into a list
...
# ----------------- PROBLEM -----------------------
# Create a random list filled with the charcters H and T
