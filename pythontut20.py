...
def get_data(event):
    ...
    # Ouput the values for the Widgets with get()
...
# You can make it so the window isn't resizeable
...
# For the font list the font family, px nd font style
...
# This shows you all the themes for you OS
