...
IV. User clicks another number button
...
button to hae been clicked make sure the click occured

Note 2: Make a way to track which math button was clicked last

Note 3: Think about a way to handle the user entering
both single numbers and multiple numbers
