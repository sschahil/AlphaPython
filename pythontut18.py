...
# We organize our data in tables by defining their name
# and the data type for the data
...
db_conn.execute("INSERT INTO Employees (FName, LName, Age, Address, Salary, HireDate)"
                "VALUES ('Jack', 'Sicso', 41, '123 Main St', '500,000', date('now'))")
