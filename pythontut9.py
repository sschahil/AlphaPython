...
# from another class. Thi is called inheritance
...
# the classes with a comma in the parenthesis


class Mammal(Animal):
    def __init__(self, birthType="born alive",
                 appearance="hair on fur",
...
class Reptile(Animal):
    ...
    # Always make sure self it is the first attribute in your class methods
...
def main():
    ...
    # are statistically typed (type is defined at declaration)
...
# like +, -, *, /, ==, >, <, etc. will work with our custom objects

# Magic methods are used for operator overloading in Python
