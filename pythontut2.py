...
while True:
    # If we expect an error acan occur surround potential error with try
    try:
...
# They always execute all of the code at least once and at the end check if a condition is true
# That would warrant runing the code again. They have this format
# do {
#   ... Bunch of code
# } while(condition)

# I'll create a guessing game in which the user must choose
...
# Hint : You'll nned a while and break
secret_number = 7
...
# ---------------------- MATH MODULE ----------------------------
# Python provides many funcitons with its Math module
import math
...
# Each character is stored in a series of boxed labeled with index numbers
...
# Cycle through each character code 2 at a time by incrementing by 2 each time through since unicodes
# go from 65 to 90
...
# ----------------------- SUPER AWESOME MIDN SCRAMBLING PROBLEM ---------------------------
# Make the above work with upper and lowercase with 1 addition and 1 subtraction
