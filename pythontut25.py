...
class StudentDB :
    ...
    def setup_db(self):
        ...
        try:
            self.db_conn.execute("CREATE TABLE if not exists Students(ID INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, \
    ...
    def update_listbox(self):
        ...
        try:
            ...
            print("1: Couldn't Rerieve Data From Database")
    ...
    def __init__(self, root):
        ...
        root.title("Student Databases")
        root.geometry("27x340")
        ...
        # Will hold the changing value stored last image_names
