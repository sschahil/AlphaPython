...
# Delete whitespaces on right
rand_string = rand_string.rstrip()

# Delete whitespaces on right and left
...
# Turn a list into a string and separate items with the defined separator
...
# Replace as substring
print(rand_string.replace("an ", "a kind of "))

# ------------------ PROBLEM : ACRONYM GENERATOR --------------------
# You will enter a string and then convert it to an acroynm
# with uppercase letters like this
'''
Convert to Acroynm : Random Access Memory
RAM
'''
...
# We call our functions by name and pass in a value between the parenthesis
print("Is a Pi a Float :", isfloat(pi))
...
# Hints
# Use lsupper() to decide which unicodes to work with
# Add the key (number of characters to shift) and if
# bigger or smaller than the unicode for A, Z, a, or z
# incresae or decrease by 26
