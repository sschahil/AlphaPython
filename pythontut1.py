...
# create a list starting at 0 and go up to but not inlcude
...
# Use a for loop, range, if and modulus to rpint out the odds

# Use for to loop through the list from 1 to 21
for i in range(1,21):

# Use modulus to check that hte result is NOT EQUAL to 0
# Print the odds
    if((i % 2) != 0):
        print("i = ", i)
...
# Have the user enter their investment will increase amount and expected interest
...
# -------------------  THE WHILE LOOP -------------------
# We can also continue looping as long as condtion is true
# with a while loop
...
# The number of spaces and hashes for the tree
# 4 - 1
# 3 - 3
# 2 - 5
# 1 - 7
...
# Get the number or rows for the tree
