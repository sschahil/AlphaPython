...
# as we will se when we cover generators, an
...
class Alphabet:
    ...
    def __init__(self):
        self.letters = "ABCDEFGHIJKLMOPQRSTUVWXYZ"
        self.index = -1
...
sumant = {"fName": "Sumant", "lName": "Chahil"}

for key in sumant:
    print(key, sumant[key])

# -------------------- PROBLEM -------------------------
# Create a clasa that returns values from the Fibonacci
...
# With a list comprehension we do
...
# ---------------------- GENERATOR FUNCTIONS -------------------------
# A generator function returns a reuslt generator when called
...
# Create a generator that calcultaes primes and returns
...
# They are surrounded by parenthesis instead of [ ]
