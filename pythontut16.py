...
# if re.search("REGEX", youString)

# Get list of matches
# print("Matches :", len(re.findall("REGEX", youString)))
...
# ----------------------- BACK REFERENCES --------------------------
# A back reference allows you to reuse the expression
# that proceeds it

# Grab a double word
randStr = "The cat cat fell out the window"

# Match a word boundary, 1 ormore characters followed
# by a space if it is then followed by the same
# match that is surrounded by the parenthesis
...
# Use the look behind, get 1 or moe of anything,
