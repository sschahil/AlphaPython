...
# fName : "Derek" where fNamee is the key and "Derek" is the value
...
# A calculating factorials is commonly done with a recursive
# function 3! = 3 * 2 * 1
...
# values to calculate the nest item in the list like this
# 1, 1, 2, 3, 5, 8 ...
