...
# The as module provides methods for file processing
import os
...
# We start the code with which guarantees the file will be
# closed if the program crashes
...
# Tuples are surrounded with parenthesis instead of square brackets
